<?php /* Smarty version Smarty-3.1.19, created on 2015-03-11 10:56:20
         compiled from "/home/dlab34/motors.designlab.com.br/application/views/contas_editar.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_550081c48024c7_88376065',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_550081c48024c7_88376065')) {function content_550081c48024c7_88376065($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/home/dlab34/motors.designlab.com.br/libraries/plugins/function.counter.php';
...
<?php }?>" placeholder="http:// ou https://"/>
                                ...
                                <h4>E-mail:</h4>
                                <p>
                                    <input type="text" class="form-control" id="email" name="email" maxlength="70" value="<?php if (isset($_smarty_tpl->tpl_vars['post_email']->value)) {?><?php echo $_smarty_tpl->tpl_vars['post_email']->value;?>
...
<?php }?>" placeholder="UF"/>
                                ...
                                <h4>Permissões:</h4>
                                <input type="checkbox" name="ADMINISTRADOR" id="ADMINISTRADOR" <?php if (isset($_smarty_tpl->tpl_vars['post_administrador']->value)) {?><?php if ($_smarty_tpl->tpl_vars['post_administrador']->value=="on") {?> checked="true" <?php }?><?php } else { ?><?php if (isset($_smarty_tpl->tpl_vars['administrador']->value)) {?> checked="true" <?php }?><?php }?>/> Administrador do Portal<br/>
                                <input type="checkbox" name="CLIENTE" id="CLIENTE" <?php if (isset($_smarty_tpl->tpl_vars['post_cliente']->value)) {?><?php if ($_smarty_tpl->tpl_vars['post_cliente']->value=="on") {?> checked="true" <?php }?><?php } else { ?><?php if (isset($_smarty_tpl->tpl_vars['cliente']->value)) {?> checked="true" <?php }?><?php }?>/> Cliente <br/>
                                ...
                                <div class="updatePassword <?php if (isset($_smarty_tpl->tpl_vars['updatePassword']->value)) {?> <?php if (isset($_smarty_tpl->tpl_vars['updatePassword']->value)!="on") {?> hide <?php }?> <?php } else { ?> hide <?php }?> ">
                                    ...
                                    <p><input type="text" class="form-control" id="lembrete" name="lembrete" maxlength="30" value="<?php if (isset($_smarty_tpl->tpl_vars['post_estado']->value)) {?><?php echo $_smarty_tpl->tpl_vars['post_lembrete']->value;?>
<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['conta']->value->LEMBRETE;?>
<?php }?>" placeholder="Lembrete de senha"/></p>
                                    <hr/>
                                </div>
