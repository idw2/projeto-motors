...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_55007b34df6ed9_17047765',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55007b34df6ed9_17047765')) {function content_55007b34df6ed9_17047765($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">

    <head>
        <meta charset="UTF-8">
        <title>DesignLab - Motors | Empresa</title>
...
<ul class="nav">
    <li  class="active" ><a href="/pt/html/empresa">A empresa</a></li>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="col-lg-6">
                        <form method="post">
                            <p><textarea class="form-control" rows="25" style="min-width: 100%" id="conteudo" name="conteudo"><p>teste</p></textarea></p>
