...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54ff3374490074_51625932',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ff3374490074_51625932')) {function content_54ff3374490074_51625932($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">

    <head>
        <meta charset="UTF-8">
        <title>DesignLab - Motors | Adicionar Usuário</title>
...
<nav class="sidebar-nav">
    ...
    <div style="background: #fff; margin: 0 11px; padding: 32px; height: 98px;"><a href="/pt/html/logomarca"><span id="logo_default"><img class="area-restrita img-responsive center-block" src="http://motors.designlab.com.br/web-files/logomarcas/355B40ACFF036DDEABA6E53BF449A60E.png" alt="" border="0" title="" /></span></a></div>
                            ...
                            <form method="post">
                                ...
                                <div class="input-group">
                                    <span class="input-group-2">
                                        <input type="radio" name="tipo_pessoa" value="pf" onclick="javascript:show_Tipopessoa('cpf')"  checked="true"  /> Pessoa Física 
                                    </span>
                                    <span class="input-group-2">
                                        <input type="radio" name="tipo_pessoa" value="pj" onclick="javascript:show_Tipopessoa('cnpj')" /> Pessoa Jurídica
                                    </span>
                                </div>
                                </p>
                                ...
                                <div class="form-inline">
                                    <input type="text" class="form-control" id="cep" name="cep" maxlength="9" value="" placeholder="CEP" style="margin-right: 15px;" onkeypress="return formataCEP(event, this);"/>
                                ...
                                <input type="checkbox" name="CLIENTE" id="CLIENTE" /> Cliente <br/>
                                ...
                                <div class="updatePassword  hide  ">
                                    ...
                                    <p><input type="text" class="form-control" id="lembrete" name="lembrete" maxlength="30" value="" placeholder="Lembrete de senha"/></p>
                                    <hr/>
                                </div>
