...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_55070210672898_73745987',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55070210672898_73745987')) {function content_55070210672898_73745987($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">

    <head>
        <meta charset="UTF-8">
        <title>DesignLab - Motors | Editar veículo</title>
            ...
            <form method="post">
                ...
                <div class="row">
                    ...
                    <div class="col col-lg-6 col-md-6">
                        ...
                        <input type="text" class="form-control" id="preco" name="preco" value="" placeholder="Preço" onkeypress="formataValor(event, this, 12);" onkeydown="backspaceFormataValor(event, this)"/>
                        <br/>
                    </div>
                </div>    
                <div class="row">
                    <div class="col col-lg-6 col-md-6">
                        ...
                        <select name="categoria" class="form-control">
                            ...
                            <option value="Seminovos" >Seminovo</option>
                ...
                <div class="row">
                    <div class="col col-lg-4 col-md-2">
                        ...
                        <input type="text" class="form-control" id="quilometragem" name="quilometragem" maxlength="40" value="" placeholder="Quilometragem" onkeypress="return formataNumDV(event, this, 40);"/>
                        <br/>
                    </div>    
                    ...
                    <div class="col col-lg-4 col-md-3">
                        ...
                        <input type="text" class="form-control" id="combustivel" name="combustivel" maxlength="25" value=""  placeholder="Combustível"/>
                        <br/>
                    </div> 
                     </div>   
        </div>   
