...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5508585968f2f4_93170849',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5508585968f2f4_93170849')) {function content_5508585968f2f4_93170849($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">

    <head>
        <meta charset="UTF-8">
        <title>DesignLab - Motors | Painel administrativo</title>
        ...
        <div class="container">
            <div class="row box-login">
                ...
                <div class="form-login">
                    ...
                    <form role="form" method="post" action="/en/admin/login">
                        <div class="form-row input-group-2">
                            <span class="input-group-addon"><i class="md-email"></i></span>
                            <input type="text" class="form-control" id="email_or_username" name="email_or_username" placeholder="E-mail or username" value=""/>
                        </div>
                        <div class="form-row input-group-2">
