...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_550079cecf3583_71773128',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_550079cecf3583_71773128')) {function content_550079cecf3583_71773128($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">

    <head>
        <meta charset="UTF-8">
        <title>DesignLab - Motors | Onde Estamos</title>
        ...
        <link href="/bootstrap-colorpicker-master/src/css/docs.css" rel="stylesheet">
        
        <link href="/web-files/animatescroll.js-master/custom.css" rel="stylesheet">
...
<ul class="nav">
    ...
    <li  class="active" ><a href="/pt/html/onde-estamos">Onde estamos</a></li>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <p><strong>Endereço:</strong><br />
                        Rua Paulo Moreno, 377 - Casa - <br>Barra da Tijuca<br>Rio de Janeiro/RJ<br>22793-690<br></p>        
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form method="post">
                                ...
                                <p><input class="form-control" style="min-width: 100%" id="conteudo" name="conteudo" value="Cristo+Redentor" placeholder="link iframe google maps"/></p>
