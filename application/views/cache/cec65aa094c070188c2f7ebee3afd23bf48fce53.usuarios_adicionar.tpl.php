...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_55031b0677bdb9_34957818',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55031b0677bdb9_34957818')) {function content_55031b0677bdb9_34957818($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">

    <head>
        <meta charset="UTF-8">
        <title>DesignLab - Motors | Create User</title>
...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="/pt/admin/welcome">paulolyra@me.com</a>
    </div>
    <!-- /.navbar-header -->
    ...
    <ul class="nav navbar-top-links navbar-right">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-user">
                                    <li><a href="/pt/admin/meus-dados/bf343f27a751f42baa982a08b0177864"><i class="fa fa-user fa-fw"></i> My Data</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form method="post">
                                ...
                                <h4>Username:</h4>
                                <div><input type="text" class="form-control" id="nome" name="nome" maxlength="15" value="" placeholder="Username"/></div>
