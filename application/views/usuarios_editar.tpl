                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form method="post">
                                ...
                                <h4>Username:</h4>
                                <div><input type="text" class="form-control" id="nome" name="nome" maxlength="15" value="{if $post_nome eq ''}{$usuario->USERNAME}{else}{$post_nome}{/if}" placeholder="Username"/></div>
                                ...
                                <div class="updatePassword {if isset($updatePassword) } {if isset($updatePassword) != "on" } hide {/if} {else} hide {/if} ">
                                    ...
                                    <div><input type="text" class="form-control" id="lembrete" name="lembrete" maxlength="30" value="{if $post_lembrete eq ''}{$usuario->LEMBRETE}{else}{$post_lembrete}{/if}" placeholder="Password reminder"/></div>
                                    <hr/>
                                </div>
