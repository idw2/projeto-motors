            ...
            <div class="panel-default">
                ...
                <table class='table' id="table-1" cellspacing="0" cellpadding="2">
                    ...
                    {foreach name=outer item=foto from=$fotos}
                        ...
                        {assign var="url_del" value="/{$language}/veiculos/delete_foto/url/{$url_amigavel}/codfoto/{$CODFOTO}"}
                        ...
                        <tr id="{$CODFOTO}" style="border-radius: 0;">
                            ...
                            <td>
                                <span style="display: inline-block; margin-right: 10px">
                                    ...
                                    <span class="ico-default-star {$star}" data-toggle="tooltip" title="Destaque"><a href="/{$language}/veiculos/foto_destaque/url/{$url_amigavel}/codfoto/{$CODFOTO}"><i class="fa fa-star"></i></a></span>
                                    <span class="ico-default-eye {$eye}" data-toggle="tooltip" title="Status"><a href="/{$language}/veiculos/foto_status/status/{$stt}/url/{$url_amigavel}/codfoto/{$CODFOTO}"><i class="fa fa-eye"></i></a></span>
                                    <span class="ico-default-edit" data-toggle="tooltip" title="Crop"><a href="#crop_{$i}" class="fancybox-crop" data-id="{$i}" onclick="javascript:getCrop('crop_{$i}');"><i class="fa fa-crop"></i></a></span>
                                                ...
                                                <div class="panel-footer" style="text-align: right;">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6" style="text-align: right;">
                                                            <a id="m-btn" onclick="release_crop('crop_{$i}', 'crop_{$i}_preview_1', '{$CODFOTO}', 1)" class="btn btn-default navbar-btn"><i class="fa fa-crop"></i> Crop</a>
                                                            <ul class="pager">
                                            ...
                                            <div class="panel panel-default show_crop_{$i}_2 hidex">  
                                                ...
                                                <div class="panel-footer" style="text-align: right;">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6" style="text-align: right;">
                                                            <a id="m-btn" onclick="release_crop('crop_{$i}', 'crop_{$i}_preview_2', '{$CODFOTO}', 2)" class="btn btn-default navbar-btn"><i class="fa fa-crop"></i> Crop</a>
                                                            <ul class="pager">
                                    ...
                                    <span class="ico-default-trash" data-toggle="tooltip" title="Excluir"><a onclick="delete_foto('{$url_del}')"><i class="fa fa-trash-o"></i></a></span>                                
